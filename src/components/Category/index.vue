  ...
  <el-card>
    <el-form :inline="true">
      ...
      <el-form-item label="二级分类">
        <el-select style="width: 280px;" :disabled="scene == 0 ? false : true" v-model="categoryStore.c2Id"
          @change="handler1">
      ...
      <el-form-item label="三级分类">
        <el-select style="width: 280px;" :disabled="scene == 0 ? false : true" v-model="categoryStore.c3Id">
